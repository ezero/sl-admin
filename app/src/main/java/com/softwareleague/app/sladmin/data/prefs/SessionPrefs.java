package com.softwareleague.app.sladmin.data.prefs;
...
public class SessionPrefs {
    ...
    public static final String PREFS_NAME = "SOFTWARE_PREFS";
    ...
    public void saveAffiliate(Affiliate affiliate) {
        if (affiliate != null) {
            ...
            editor.putString(PREF_AFFILIATE_NAME, affiliate.getNombre());
            editor.putString(PREF_AFFILIATE_ADDRESS, affiliate.getTipo());
            editor.putString(PREF_AFFILIATE_GENDER, affiliate.getEstado());
